...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "hero.lead": "Polymarket owns English-speaking crypto. Merlat is building the product thesis for Spanish & Portuguese speakers: local markets, native UX, and local payment rails.",
      ...
      "hero.title": "A LATAM prediction market",
    ...
    es: {
      ...
      "hero.lead": "Polymarket domina el cripto en inglés. Merlat construye la tesis de producto para hablantes de español y portugués: mercados locales, UX nativa y rieles de pago locales.",
      ...
      "hero.stat3short": "Fees · gov · stake",
      "hero.title": "Un mercado de predicción LATAM",
