...
**Created:** 2026-09-23 (America/Costa_Rica)
...
| Folder | Role |
|---|---|
| `/workspace/merlat-landing-v1-editorial/` | **Preserved** Behance editorial brutalism snapshot — do not overwrite |
| `/workspace/merlat-landing/` | Working / earlier tree (may still hold refs); **do not modify for this v2 task** |
