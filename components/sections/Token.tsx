...
export function Token() {
  ...
  return (
    <section className="section section--token" id="token">
      <TokenCoins />
      <div className="token-scrim" aria-hidden="true" />
      <div className="container">
        ...
        <div className="feature-grid" data-reveal-stagger>
          {UTILITIES.map((item) => (
            <article className="card card--on-dark" key={item.title}>
        ...
        <div className="contract-panel card card--on-dark" data-reveal>
